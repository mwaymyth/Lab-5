...
function loadStatsPage(){
	...
	{
			cell1_val = table.rows[row_counter].cells[2].innerHTML;
			cell2_val = table.rows[row_counter].cells[3].innerHTML;
			if(parseInt(cell1_val) > parseInt(cell2_val)){
...
function loadPlayersPage(){
	...
	for(var i=0 ; i < players.length; i++){
		select_text += '<a href="#" onclick="switchPlayers(' + i + ')">' + players[i].name + '</a><br>';
	}
	document.getElementById("player_selector").innerHTML = select_text;
}
